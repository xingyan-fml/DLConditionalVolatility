...
def fit_model_hnn(train_data, valid_data, y, num_iter, hidden_dims, num_epochs, batch_size, lr, set_seed, penalty):
    ...
    for n in range(num_iter):
        ...
        model_var, v_hat_train, v_hat_valid = fit_variance_nn(train_data, valid_data, y, Y_hat_train, Y_hat_valid, hidden_dims, num_epochs, batch_size, lr, set_seed + n * 101 + 2, penalty)
