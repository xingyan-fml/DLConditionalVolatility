...
def pred(data_name, info, y, hidden_dims, lr, penalty, num_iter):
    ...
    data = pd.read_csv('../preprocessing/'+data_name+'_top.csv')
...
#============================================================================== 
    ...
    results_single.to_csv(data_dir + "{}_{}_{}_{}_{}_top.csv".format(hidden_dims,lr,penalty,num_iter,1), index = False)
    results_ensemble.to_csv(data_dir + "{}_{}_{}_{}_{}_top.csv".format(hidden_dims,lr,penalty,num_iter,nn_Num), index = False)
    ...
    if not os.path.isfile(data_dir + "oos_r2_top.csv"):
        with open(data_dir + "oos_r2_top.csv", 'a') as file:
